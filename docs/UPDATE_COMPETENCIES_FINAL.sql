-- Script final para atualizar a tabela competencies com os subtopic_name reais
-- Baseado na estrutura atual da tabela (apenas id, name, description)
...
-- 3. Verificar o resultado (apenas colunas que existem)
SELECT 
    id,
    name,
    description
