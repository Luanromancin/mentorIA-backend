-- Corrigir constraint da tabela user_statistics e inserir dados de teste
-- Execute este script no SQL Editor do Supabase

-- 1. Adicionar constraint única se não existir
ALTER TABLE user_statistics 
ADD CONSTRAINT user_statistics_user_topic_subtopic_unique 
UNIQUE (user_id, topic_name, subtopic_name);

-- 2. Inserir estatísticas de teste para o usuário
...
-- 4. Testar a função getUserStatistics com dados
