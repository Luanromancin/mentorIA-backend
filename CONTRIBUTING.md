...
### 2.2. Frontend
- Repositório: [https://github.com/gabrielalimasotero/MentorIA-Frontend](https://github.com/gabrielalimasotero/MentorIA-Frontend)
- Comando:
  ```bash
  git clone https://github.com/SEU_USUARIO/MentorIA-Frontend.git
  ```
